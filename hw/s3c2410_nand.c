...
void s3c2410_nand_register(void * opaque, struct nand_flash_s *chip)
{
    struct s3c2410_nand_s *s = (struct s3c2410_nand_s *) opaque;
    s->nand = chip;
}

void s3c2410_nand_setwp(void * opaque, int wp)
{
    struct s3c2410_nand_s *s = (struct s3c2410_nand_s *) opaque;
    s->nfwp = wp;
}
...
struct s3c_nand_driver_s * s3c2410_nand_init()
{
	...
	register_savevm("s3c24xxb10_nand", 0, 0, s3c2410_nand_save, s3c2410_nand_load, nand);
	return &nand->driver;
}
